...
//                 <input type="number" id="phone" name="phone" pattern="[0-9]{3}-[0-9]{4}-[0-9]{4}" required
//                     placeholder="Please enter your phone number" className="field"/>
//                 <label htmlFor="age" id="age">Date of Birth:</label>
//                 <input onChange={handleChange} type="date" id="age" name="age" value="2000-01-01" min="1940-01-01" max="2022-12-31" className="field"/>

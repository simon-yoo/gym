  ...
  return (
    <div className="header">
      ...
      <div className="dropdown_menu">
        <Link to={'/'}>
          <li className="drop-link">HOME</li>
        </Link>
        <Link to={'about'}>
          <li className="drop-link">About</li>
        </Link>
        <Link to={'membership'}>
          <li className="drop-link">Membership</li>
        </Link>
        <Link to={'location'}>
          <li className="drop-link">Location</li>
        </Link>
        <Link to={'contact'}>
          <li className="drop-link">Contact</li>
        </Link>
      ...
      <div className="text-box">
        ...
        <p>
          We are no.1 GYM all around the WORLD! <br /> We give you Motivation,
